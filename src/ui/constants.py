...
class TaskConst():
  ...
  ADMIN_APPROVE = 'TASK:APPROVE'
  ADMIN_REJECT = 'TASK:REJECT'
  MENU = 'TASK:MENU'
  ...
  FILTER_ACTIVE = 'TASK:FILTER_ACTIVE'
  FILTER_COMPLETED = 'TASK:FILTER_COMPLETED'
...
class ContrConst():
  ...
  SELECT_FOR_REPORT = 'CONTRACTOR:SELECT_FOR_REPORT'
...
class AccConst():
  ...
  # Connections
  ADD = 'BUILDING:ADD_ACCESSORY'
  EDIT = 'BUILDING:EDIT_ACCESSORY'
  SAVE = 'BUILDING:SAVE_ACCESSORY'
...
class SearchConst():
  ...
  CONTRACTOR_FOR_REPORT = 'SEARCH:CONTRACTOR_FOR_REPORT'
  ...
  TASK_BY_LOCATION = 'SEARCH:TASK_BY_LOCATION'
  TASK_BY_CONTRACTOR = 'SEARCH:TASK_BY_CONTRACTOR'
