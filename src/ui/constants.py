...
class LocConst():
  ...
  LOCATION_PARAM = 'LOCATION:EMPLOYEE'
...
class BuildConst():
  ...
  BUILDING_PARAM = 'BUILDING:EMPLOYEE'
...
class ContrConst():
  ...
  CONTRACTOR_PARAM = 'CONTRACTOR:EMPLOYEE'
...
class AccConst():
  ...
  ACCESSORY_PARAM = 'ACCESSORY:EMPLOYEE'
